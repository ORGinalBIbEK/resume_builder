...
const CallToAction = () => {
    return (
        <>
            ...
            `}</style>
            <div id = 'cta'
                className="max-w-5xl py-16 md:pl-24 md:w-full mx-2 md:mx-auto flex flex-col items-start justify-center text-left bg-gradient-to-b from-[#16b710] to-[#180047] rounded-2xl p-10 text-white">
                ...
                <button className="px-12 py-2.5 text-white border border-green-600 bg-green-700/60 hover:bg-green-800 transition-all rounded-full text-sm mt-4">
                    Get Started
                </button>
            </div>
        </>
