  ...
  return ( 
    <div className="py-10 bg-slate-50 overflow-hidden">
      ...
      <div className="marquee-row w-full mx-auto max-w-7xl overflow-hidden relative mb-4">
        ...
        <div className="marquee-inner flex transform-gpu min-w-[200%] py-2 animate-marquee">
      ...
      <div className="marquee-row w-full mx-auto max-w-7xl overflow-hidden relative">
        <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-slate-50 to-transparent"></div>
        <div className="marquee-inner flex transform-gpu min-w-[200%] py-2 animate-marquee-reverse">
          {[...cardsData, ...cardsData].map((card, index) => (
