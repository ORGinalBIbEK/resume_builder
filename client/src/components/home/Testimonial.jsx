...
const Testimonial = () => {
 ...
 const CreateCard = ({ card }) => (
  <div className="p-4 rounded-xl mx-4 shadow-sm border border-gray-100 bg-white hover:shadow-md transition-all duration-200 w-72 shrink-0">
    <div className="flex gap-2">
      <img className="size-11 rounded-full object-cover" src={card.image} alt="User Image" />
      <div className="flex flex-col">
        <div className="flex items-center gap-1">
          <p className="font-semibold text-sm text-gray-950">{card.name}</p>
          
          {/* Changed 'fill-green-500' to 'text-green-500' for native SVG standard support */}
          <svg className="mt-0.5 text-green-500 shrink-0" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* FIX: Changed fill="#2196F3" to fill="currentColor" */}
      ...
      <div className="flex items-center justify-between text-slate-400 text-xs pt-1 border-t border-gray-50">
        <div className="flex items-center gap-1">
          <span>Posted on</span>
  ...
  return ( 
    <>
      {/* 1. Main header block arranged vertically */}
      <div id='testimonials' className="flex flex-col items-center justify-center mt-16 mb-12 px-4 text-center">
        
        {/* 2. Compact centered badge */}
      ...
      {/* Marquee Row 1 */}
      <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative mb-2">
      ...
      {/* Marquee Row 2 */}
      <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative mb-16">
        <div className="absolute left-0 top-0 h-full w-24 z-10 pointer-events-none bg-gradient-to-r from-white to-transparent"></div>
      ...
      {/* Injected Style Tags for the Smooth Infinite Scrolling Animation */}
      <style>{`
