...
const Banner = () => {
  return (
    ...
    <div className="flex flex-wrap items-center justify-center gap-2 w-full px-4 md:px-14 py-4 font-medium text-sm text-black text-center bg-gradient-to-r from-green-500 to-purple-100">
